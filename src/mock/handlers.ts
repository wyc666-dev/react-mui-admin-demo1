...
export const handlers = [ // 导出接口拦截列表，给 browser.ts 使用。
  ...
  http.get("/api/products", () => {
    return HttpResponse.json({
      list: [
        { id: 1, name: "无线蓝牙耳机", price: 299, stock: 86, category: "数码", image: "https://picsum.photos/seed/product-1/120/120" },
        { id: 2, name: "轻薄办公笔记本", price: 5299, stock: 24, category: "电脑", image: "https://picsum.photos/seed/product-2/120/120" },
        { id: 3, name: "纯棉短袖 T 恤", price: 89, stock: 150, category: "服饰", image: "https://picsum.photos/seed/product-3/120/120" },
      ],
    });
  }),
